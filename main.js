...
$( document ).ready(function() {
  ...
  $('#main-example').mousedown(function() {$('#main-example-container').append('<img style="vertical-align: top; margin-top: 70px; margin-left: -100px;" src="images/hadouken.gif" class="moving-hadouken">');});
